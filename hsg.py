...
def homepage():
    ...
    def booklist_():
        ...
        for i in range(75):
            ...
            genre = l[i][3]
            agelimit = l[i][4]
            ins = "insert into booklist values({},'{}','{}','{}','{}')".format(Slot_n, Bookname, Author, Genre, Age_limit)
            ...
            def Latest():
               ...
               while True:
                        ...
                        if Bk == "NO" or Bk == 'no':
                                ...
                                return 0
                        if Bk not in("JOURNEY TO THE CENTRE OF THE EARTH","THE HARRY POTTER SERIES","THE PILLARS OF THE EARTH (SERIES)","GHOST WORLD"):
